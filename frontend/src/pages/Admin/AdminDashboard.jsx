...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      const [statsResponse, ordersResponse, reportsResponse] = await Promise.all([
        axios.get('http://localhost:5000/api/admin/stats'),
        axios.get('http://localhost:5000/api/admin/orders?limit=5'),
        axios.get('http://localhost:5000/api/admin/reports/sales?period=all')
      ]);
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Add items to your menu</p>
                </div>
              </Link>
              
              <Link to="/admin/orders" className={`flex items-center w-full p-4 text-left bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors space-x-3 ${
                  location.pathname === '/admin/orders' ? 'text-green-600' : 'text-gray-700'
                }`}
              >
              ...
              <Link to="/admin/reports" className={`flex items-center w-full p-4 text-left bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors ${
                  location.pathname === '/admin/reports' ? 'text-green-600' : 'text-gray-700'
                }`}
              >
