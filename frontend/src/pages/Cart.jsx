                  ...
                  <div key={`${cartItem.item._id}-${index}`} className="p-6">
                    <div className="flex space-x-4">
                      <div className="flex-shrink-0 w-16 h-16 bg-gray-200 rounded-md overflow-hidden">
                        {cartItem.item.image ? (
                          <img 
                            src={`http://localhost:5000${cartItem.item.image}`} 
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right">
                            ...
                            <button
                              onClick={() => removeFromCart(cartItem.item._id, cartItem.customizations)}
                        ...
                        <div className="flex items-center justify-between mt-4">
                          <div className="flex items-center space-x-3">
                            <button
                              onClick={() => updateQuantity(cartItem.item._id, cartItem.customizations, cartItem.quantity - 1)}
