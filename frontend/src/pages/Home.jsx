...
const Home = () => {
  ...
  const fetchPopularItems = async () => {
    try {
      const response = await axios.get(
        "https://qr-based-kitchen.vercel.app/api/menu/popular/items"
      );
  ...
  const features = [
    {
      ...
      title: "Scan & Order",
      description:
        "Simply scan the QR code at your table to access the menu instantly",
    },
    {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section
        className="bg-gradient-to-br from-green-50 to-green-100 bg-cover bg-center bg-no-repeat py-20"
        style={{
          backgroundImage:
            "linear-gradient(rgba(0,0,0,0.8), rgba(0,0,0,0.5)), url('/Canteen2.jpg')",
        }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-white mb-8 max-w-2xl mx-auto">
              Your favorite campus food, now just a scan away. Order, track, and
              enjoy delicious meals without the wait.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="text-center p-8 rounded-lg border hover:shadow-lg transition-shadow"
              >
