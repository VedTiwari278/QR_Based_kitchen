                ...
                <div className="border-b border-gray-200 p-6">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {getTotalItems(order)} items • ₹{order.totalAmount || order.total}
                      </p>
                    </div>
                ...
                <div className="p-6">
                        ...
                        <div className="flex-1">
                          <div className="flex items-start space-x-3">
                            <div className="flex-shrink-0 w-12 h-12 bg-gray-200 rounded-md overflow-hidden">
                              {item.item?.image ? (
                                <img 
                                  src={`http://localhost:5000${item.item.image}`} 
                                  alt={item.name}
                  ...
                  <div className="border-t border-gray-200 mt-4 pt-4">
                    ...
                    <div className="flex justify-between items-center text-lg font-semibold border-t pt-2">
                      <span>Total</span>
                      <span className="text-green-600">₹{order.totalAmount || order.total}</span>
                    </div>
                  </div>
